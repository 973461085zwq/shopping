...
//当前访问的主机名
define('SITE_URL', (isset($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : '')); //localhost
//来源
...
class pc_base {
	...
	public static function my_path($filepath) {
		...
		//["dirname"]=> string(49) "D:\wamp\apache2\htdocs\phpcms\phpcms\libs\classes" ["basename"]=> string(21) "application.class.php" ["extension"]=> string(3) "php" ["filename"]=> string(17) "application.class"
		// MY_application.class.php
